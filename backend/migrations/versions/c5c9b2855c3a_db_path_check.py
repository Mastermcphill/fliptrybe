...
def upgrade():
    # SQLite safety: create each table/index only if missing.
    # ### commands auto generated by Alembic - please adjust! ###
    _create_table_if_missing('audit_logs',
    ...
    _create_table_if_missing('autopilot_settings',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    _create_table_if_missing('commission_rules',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('commission_rules', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'commission_rules')
    ...
    _create_table_if_missing('disabled_listings',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('disabled_listings', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'disabled_listings')
        batch_op.create_index(batch_op.f('ix_disabled_listings_listing_id'), ['listing_id'], unique=True)

    _create_table_if_missing('disabled_users',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('disabled_users', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'disabled_users')
        batch_op.create_index(batch_op.f('ix_disabled_users_user_id'), ['user_id'], unique=True)

    _create_table_if_missing('driver_job_offers',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    _create_table_if_missing('driver_jobs',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('driver_jobs', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'driver_jobs')
    ...
    _create_table_if_missing('merchant_reviews',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    _create_table_if_missing('notification_queue',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    _create_table_if_missing('payment_intents',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    _create_table_if_missing('payment_transactions',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('provider', sa.String(length=32), nullable=False),
    sa.Column('reference', sa.String(length=128), nullable=False),
    ...
    _create_table_if_missing('payout_recipients',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('provider', sa.String(length=32), nullable=False),
    ...
    _create_table_if_missing('payouts',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    ...
    _create_table_if_missing('shortlets',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    _create_table_if_missing('transactions',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    _create_table_if_missing('users',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'users')
        batch_op.create_index(batch_op.f('ix_users_email'), ['email'], unique=True)

    _create_table_if_missing('webhook_events',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('provider', sa.String(length=32), nullable=False),
    ...
    _create_table_if_missing('withdrawals',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('amount', sa.Float(), nullable=False),
    ...
    with op.batch_alter_table('withdrawals', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'withdrawals')
        batch_op.create_index(batch_op.f('ix_withdrawals_user_id'), ['user_id'], unique=False)

    _create_table_if_missing('bond_events',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('driver_profiles', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'driver_profiles')
        batch_op.create_index(batch_op.f('ix_driver_profiles_user_id'), ['user_id'], unique=True)

    _create_table_if_missing('inspector_bonds',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('inspector_user_id', sa.Integer(), nullable=False),
    ...
    _create_table_if_missing('kyc_requests',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('status', sa.String(length=32), nullable=False),
    ...
    _create_table_if_missing('listings',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    ...
    with op.batch_alter_table('listings', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'listings')
    ...
    _create_table_if_missing('merchant_profiles',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    _create_table_if_missing('payout_requests',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('amount', sa.Float(), nullable=False),
    sa.Column('status', sa.String(length=24), nullable=False),
    ...
    with op.batch_alter_table('payout_requests', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'payout_requests')
        batch_op.create_index(batch_op.f('ix_payout_requests_user_id'), ['user_id'], unique=False)

    _create_table_if_missing('receipts',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    _create_table_if_missing('shortlet_bookings',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    _create_table_if_missing('support_tickets',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    _create_table_if_missing('user_settings',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('user_settings', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'user_settings')
        batch_op.create_index(batch_op.f('ix_user_settings_user_id'), ['user_id'], unique=True)

    _create_table_if_missing('wallets',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('wallets', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'wallets')
        batch_op.create_index(batch_op.f('ix_wallets_user_id'), ['user_id'], unique=True)

    _create_table_if_missing('orders',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('orders', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'orders')
    ...
    _create_table_if_missing('wallet_txns',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('wallet_txns', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'wallet_txns')
    ...
    _create_table_if_missing('inspection_audits',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('order_id', sa.Integer(), nullable=False),
    sa.Column('inspector_user_id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('inspection_audits', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'inspection_audits')
    ...
    _create_table_if_missing('inspection_reviews',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('order_id', sa.Integer(), nullable=False),
    sa.Column('inspector_user_id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('inspection_reviews', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'inspection_reviews')
    ...
    _create_table_if_missing('order_events',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('order_id', sa.Integer(), nullable=False),
    sa.Column('actor_user_id', sa.Integer(), nullable=True),
    ...
    with op.batch_alter_table('order_events', schema=None) as batch_op:
        _guard_batch_create_index(batch_op, 'order_events')
