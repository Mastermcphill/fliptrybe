...
class AdminNotifyQueueService {
  ...
  Future<Map<String, dynamic>> markSent(int id) async {
    final data = await ApiClient.instance.postJson(ApiConfig.api('/admin/notify-queue/$id/mark-sent'), {});
    return data is Map ? Map<String, dynamic>.from(data) : <String, dynamic>{};
  }

  Future<Map<String, dynamic>> requeue(int id) async {
    final data = await ApiClient.instance.postJson(ApiConfig.api('/admin/notify-queue/$id/requeue'), {});
    return data is Map ? Map<String, dynamic>.from(data) : <String, dynamic>{};
  }

  Future<Map<String, dynamic>> retryNow(int id) async {
    final data = await ApiClient.instance.postJson(ApiConfig.api('/admin/notify-queue/$id/retry-now'), {});
    return data is Map ? Map<String, dynamic>.from(data) : <String, dynamic>{};
  }
